    ...
    [ 
     ...
     answers: ["Arabica","Java","Kona","Typica"],
      ...
      correct: "PostScript"
          ...
          question: "Influential programming language, published in 1970 by Niklaus Wirth as a small and efficient language intended to encourage good programming practices using structured programming and data structuring", answers: ["Pascal","Perl","Python","PHP"], correct: "Pascal"
        }, 
     ...
     answers: ["Python","AWK","Ruby","Miranda"], correct: "Ruby"
     
     }, 
     
     { 
     
     question: "What does JSON stands for?", answers: ["JavaScript scripting Object Notation","JavaScript OpenSource Network","JavaScript Object Notation","None of the above"], 
